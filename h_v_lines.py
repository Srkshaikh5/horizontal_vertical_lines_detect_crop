...
def vertical_crop_image(h_images,stem,df_with_h_coordinates):
    ...
    for src, idx in zip(h_images,df_with_h_coordinates.itertuples()):
        ...
        if len(src.shape) != 2:
            ...
            gray = src
        cv2.imwrite("C://Users//priya.lotankar//sept_2019//DPI_images//New_folder//h_image.jpg",gray)
...
def hv_lines(dir):
    ...
    vertical_df.to_csv("C://Users//priya.lotankar//sept_2019//DPI_images//New_folder//vertical_df.csv")
    df_with_h_coordinates.to_csv("C://Users//priya.lotankar//sept_2019//DPI_images//New_folder//horizontal_df.csv")
    return image_blocks,original_image, df_with_h_coordinates, df_with_v_coordinates

image_block,original_img, df_h_coordiantes, df_v_coordinates = hv_lines("C://Users//priya.lotankar//sept_2019//DPI_images//New_folder")
#
# f  = open("abc.txt","w")
